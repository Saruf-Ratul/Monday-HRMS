...
namespace mondayWebApp.Models
{
    public class Employee
    {
        ...
        [Required(ErrorMessage = "Proszę wprowadzić adres email worker's.")]
        [StringLength(50)]
        [EmailAddress]
        ...
        [Required(ErrorMessage = "Proszę wprowadzić imię worker's.")]
        [StringLength(50)]
        public string EmployeeName { get; set; }
        [Required(ErrorMessage = "Proszę wprowadzić nazwisko worker's.")]
        [StringLength(50)]
        ...
        // Wskazuje czy kierownik project
