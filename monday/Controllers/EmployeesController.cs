...
namespace mondayWebApp.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        /// <summary>
        /// Akcja przygotowuje widok z danymi szczegółowymi wybranego worker's.
        /// </summary>
        /// <param name="id">Numer ID wybranego worker's.</param>
        /// <returns>Widok danych szczegółowych wybranego worker's.</returns>
        ...
        /// <summary>
        /// Akcja przygotowuje formularz dodawania nowego worker's do bazy danych.
        /// </summary>
        /// <returns>Widok formularza dodawania nowego worker's.</returns>
        ...
        /// <summary>
        /// Akcja dodaje utworzonego worker's do bazy danych.
        /// Dane pobierane są z formularza dodawania nowego worker's.
        /// </summary>
        /// <param name="employee">Dane z formularza dodawania nowego worker's.</param>
        ...
        /// <summary>
        /// Akcja przygotowująca widok z formularzem edycji wybranego worker's firmy.
        /// </summary>
        /// <param name="id">Nume ID wybranego worker's firmy.</param>
        /// <returns>Widok formularza edycji wybranego worker's.</returns>
        [Authorize(Roles = "Superadmin, Admin")]
        ...
        /// <summary>
        /// Akcja edytująca wybranego employee.
        /// Zmiany zapisuje w bazie danych.
        /// </summary>
        /// <param name="id">Numer ID wybranego worker's do edycji.</param>
        /// <param name="employee">Dane z formularza edycji worker's.</param>
        ...
        /// <summary>
        /// Akcja przygotowująca widok podsumowania usuwanego worker's firmy.
        /// </summary>
        /// <param name="id">Numer ID wybranego worker's do usunięcia.</param>
        /// <returns>Widok z podsumowaniem usuwanego worker's.</returns>
        ...
        /// <summary>
        /// Akcja usuwająca wybranego worker's.
        ...
        /// <summary>
        /// Metoda sprawdzająca istnienie wybranego employee w bazie danych.
        /// </summary>
        /// <param name="id">Numer ID wybranego worker's.</param>
        /// <returns>Prawda/Fałsz istnienia worker's w bazie danych.</returns>
