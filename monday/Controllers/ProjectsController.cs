...
namespace mondayWebApp.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        /// </summary>
        /// <param name="id">Numer ID wybranego project.</param>
        /// <returns>Widok z szczegółowymi danymi project.</returns>
        ...
        /// <summary>
        /// Akcja przygotowująca formularz do dodania nowego project.
        /// </summary>
        ...
        /// </summary>
        /// <param name="project">Dane project z formularza.</param>
        ...
        /// <summary>
        /// Akcja przygotowująca widok z formularzem edycji wybranego project.
        /// </summary>
        /// <param name="id">Numer ID wybranego project.</param>
        /// <returns>Widok z formularzem edycji wybranego project.</returns>
        // GET: Projects/Edit/5
        ...
        /// </summary>
        /// <param name="id">Numer ID edytowanego project.</param>
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ProjectID,ProjectName,ProjectDesc,ProjectBrief,ProjectDeadline,ProjectManagerID,IsEdited,IsChecked")] Project project)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        if(TempBox == null) // Edition po usunięciu kierownika project
                        {
        ...
        /// <summary>
        /// Akcja przygotowująca widok podsumowania wybranego do usunięcia project.
        /// </summary>
        /// <param name="id">Numer ID wybranego project.</param>
        /// <returns>Widok podsumowania wybranego do usunięcia project.</returns>
        ...
        /// Zmiany zapisuje w bazie danych.
        /// </summary>
        /// <param name="id">Numer ID usuwanego project.</param>
        ...
        /// <summary>
        /// Metoda sprawdza istnienie project w bazie danych.
        /// </summary>
        /// <param name="id">Numer ID wybranego project.</param>
        /// <returns>Prawda/Fałsz istnienia project w bazie danych.</returns>
